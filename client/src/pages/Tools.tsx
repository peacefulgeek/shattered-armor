...
const CATEGORIES: Category[] = [
  {
    ...
    products: [
      ...
      { name: "Healing the Fragmented Selves of Trauma Survivors — Janina Fisher", description: "Fisher bridges IFS and somatic approaches in a way that makes structural dissociation finally make sense. Essential for anyone working with parts.", url: "https://www.amazon.com/dp/0415708230?tag=spankyspinola-20", isAmazon: true },
      ...
      { name: "The Tao of Fully Feeling — Pete Walker", description: "Walker's exploration of grief as a healing force. Less well-known than his C-PTSD book but equally important. This one is about learning to feel again after years of numbness.", url: "https://www.amazon.com/dp/0061284335?tag=spankyspinola-20", isAmazon: true },
    ],
  },
  {
    ...
    products: [
      ...
      { name: "Polyvagal Exercises for Safety and Connection — Deb Dana", description: "Hands-on exercises for mapping your nervous system states and building regulation capacity. Each exercise is clearly explained with variations for different comfort levels.", url: "https://www.amazon.com/dp/0393713415?tag=spankyspinola-20", isAmazon: true },
      { name: "The DBT Skills Workbook — Matthew McKay", description: "Dialectical behavior therapy skills for distress tolerance, emotional regulation, and interpersonal effectiveness. Structured and evidence-based.", url: "https://www.amazon.com/dp/B09M6GXR43?tag=spankyspinola-20", isAmazon: true },
      { name: "Trauma Recovery Journal", description: "A dedicated journaling practice is one of the most effective self-regulation tools available. This guided journal provides prompts specifically designed for trauma processing and nervous system awareness.", url: "https://www.amazon.com/dp/B0D7F9WP9K?tag=spankyspinola-20", isAmazon: true },
    ],
  },
  {
    ...
    products: [
      ...
      { name: "Acupressure Mat — ProsourceFit", description: "Thousands of pressure points provide intense somatic grounding. Lying on this for 15-20 minutes can shift you from sympathetic overdrive into ventral vagal. Not comfortable at first — that is the point.", url: "https://www.amazon.com/dp/B09X6DNR4G?tag=spankyspinola-20", isAmazon: true },
      { name: "Breathing Trainer — Komodo", description: "Resistance breathing builds vagal tone more effectively than unassisted breathwork. This device provides calibrated resistance on both inhale and exhale. We discuss the science behind this in our breathwork articles.", url: "https://www.amazon.com/dp/B09XS7JWHH?tag=spankyspinola-20", isAmazon: true },
  ...
  },
  {
    ...
    products: [
      { name: "Magnesium Glycinate — NOW Supplements", description: "Magnesium supports GABA production and nervous system regulation. Glycinate is the most bioavailable form and least likely to cause digestive issues. Many trauma survivors are chronically deficient.", url: "https://www.amazon.com/dp/B000BD0RT0?tag=spankyspinola-20", isAmazon: true },
      ...
      { name: "Light Therapy Lamp — Verilux", description: "Circadian rhythm disruption is common in trauma survivors. A 10,000 lux light therapy lamp used for 20-30 minutes each morning can help reset your body's internal clock and improve sleep quality.", url: "https://www.amazon.com/dp/B0D1XD1ZV3?tag=spankyspinola-20", isAmazon: true },
    ],
  },
  {
