    ...
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--background)' }}>
      ...
      <main className="flex-1 container py-12">
        <div className="max-w-3xl mx-auto article-body">
          ...
          <p>No content on this site creates a therapeutic, medical, or professional relationship between the reader and the author. {SITE.author} is a consciousness teacher and writer, not a licensed therapist or physician.</p>
          ...
          <p>This site contains links to external websites for reference purposes. We do not control or endorse the content of external sites. Links to research papers, professional organizations, and other resources are provided for educational context.</p>
        </div>
      </main>
      <Footer />
    </div>
