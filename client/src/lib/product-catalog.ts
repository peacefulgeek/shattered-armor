...
export const PRODUCTS: Product[] = [
  ...
  { name: "Nurturing Resilience", asin: "1623172039", category: "books", tags: ["developmental", "childhood", "attachment", "resilience", "somatic"], softIntro: "For those interested in developmental trauma, you could also try" },
  ...
  { name: "The Tao of Fully Feeling", asin: "0061284335", category: "books", tags: ["grief", "feelings", "emotional-flashback", "pete-walker", "crying"], softIntro: "For those working through grief and emotional flashbacks, you might try" },
  ...
  { name: "The Deepest Well", asin: "1250223180", category: "books", tags: ["aces", "childhood", "health", "stress", "nadine-burke-harris"], softIntro: "A book connecting childhood adversity to health outcomes is" },
  ...
  // === SUPPLEMENTS (25) ===
  { name: "Nature Made Magnesium Glycinate 400mg", asin: "B000BD0RT0", category: "supplements", tags: ["magnesium", "sleep", "anxiety", "nervous-system", "relaxation", "muscle"], softIntro: "One supplement that many people find calming for their nervous system is" },
  ...
  { name: "Thorne Vitamin B Complex", asin: "B0013OQGO6", category: "supplements", tags: ["b-vitamins", "energy", "stress", "nervous-system", "fatigue"], softIntro: "For those dealing with fatigue from chronic stress, consider" },
  { name: "Natrol Melatonin 5mg Time Release", asin: "B0009F3QKW", category: "supplements", tags: ["sleep", "insomnia", "circadian", "nighttime", "rest"], softIntro: "A gentle sleep support that works for many people is" },
  { name: "Gaia Herbs Passionflower", asin: "B000H7P9M0", category: "supplements", tags: ["anxiety", "calm", "sleep", "herbal", "nervous-system"], softIntro: "An herbal option that some find soothing for anxiety is" },
  { name: "Pure Encapsulations GABA", asin: "B07P5K7DQP", category: "supplements", tags: ["gaba", "anxiety", "calm", "nervous-system", "relaxation"], softIntro: "For calming an overactive nervous system, you could also try" },
  { name: "Life Extension Glycine 1000mg", asin: "B07P5K7DQP", category: "supplements", tags: ["glycine", "sleep", "calm", "nervous-system", "amino-acid"], softIntro: "A simple amino acid that many find helpful for sleep quality is" },
  ...
  { name: "Loop Quiet Ear Plugs", asin: "B0D3V4V1KD", category: "sensory-tools", tags: ["noise", "sensory", "quiet", "earplugs", "overwhelm", "sound"], softIntro: "A discreet option for reducing noise sensitivity is" },
  ...
  { name: "Spiky Sensory Ring Set", asin: "B0969BJG53", category: "sensory-tools", tags: ["fidget", "grounding", "sensory", "anxiety", "touch", "stimulation"], softIntro: "A grounding tool that many find helpful during anxious moments is" },
  { name: "Kinetic Sand", asin: "B073429DV2", category: "sensory-tools", tags: ["sensory", "grounding", "touch", "calm", "tactile", "soothing"], softIntro: "For tactile grounding that engages the senses, you might try" },
  { name: "Acupressure Mat and Pillow Set", asin: "B09X6DNR4G", category: "sensory-tools", tags: ["body", "tension", "pain", "somatic", "release", "acupressure"], softIntro: "A body tool that some find helpful for releasing chronic tension is" },
  { name: "TheraPearl Eye Mask", asin: "B001EWD7KI", category: "sensory-tools", tags: ["eyes", "headache", "sensory", "calm", "cold", "soothing"], softIntro: "For soothing sensory overwhelm around the eyes and forehead, consider" },
  { name: "Calm Strips Sensory Stickers", asin: "B0969BJG53", category: "sensory-tools", tags: ["fidget", "grounding", "texture", "anxiety", "discreet", "tactile"], softIntro: "A discreet grounding tool you can stick anywhere is" },
  ...
  { name: "The PTSD Workbook", asin: "B09M6GXR43", category: "journals", tags: ["ptsd", "workbook", "cbt", "exercises", "coping", "skills"], softIntro: "For those wanting structured exercises, a helpful workbook is" },
  ...
  { name: "Trauma Recovery Journal", asin: "B0D7F9WP9K", category: "journals", tags: ["journal", "trauma", "prompts", "writing", "healing", "reflection"], softIntro: "A guided journal specifically designed for trauma recovery is" },
  ...
  { name: "The Body Awareness Workbook for Trauma", asin: "1684034582", category: "journals", tags: ["body", "somatic", "awareness", "interoception", "workbook"], softIntro: "A workbook that helps rebuild body awareness after trauma is" },
  ...
  { name: "Theragun Mini", asin: "B0DV7JN7ZD", category: "body-tools", tags: ["body", "tension", "percussion", "muscle", "somatic", "release"], softIntro: "For targeted muscle tension release, a popular option is" },
  { name: "Yoga Mat - Manduka PRO", asin: "0393712370", category: "body-tools", tags: ["yoga", "body", "movement", "somatic", "grounding", "practice"], softIntro: "A quality yoga mat for body-based practices is" },
  ...
  { name: "Lacrosse Ball for Trigger Points", asin: "B00HD0ELFK", category: "body-tools", tags: ["body", "tension", "trigger-point", "fascia", "release", "pain"], softIntro: "A simple tool for working with specific tension points is" },
  ...
  { name: "Chirp Wheel Back Roller", asin: "B002CQU564", category: "body-tools", tags: ["back", "spine", "tension", "release", "body", "somatic"], softIntro: "For releasing tension along the spine, a tool worth considering is" },
  ...
  { name: "Manta Sleep Mask", asin: "B00K5NEPJY", category: "sleep", tags: ["sleep", "mask", "darkness", "rest", "sensory", "light"], softIntro: "A sleep mask that blocks all light for better rest is" },
  ...
  { name: "Hatch Restore Sound Machine", asin: "B0C67ZDQLX", category: "sleep", tags: ["sleep", "sound", "white-noise", "routine", "calm", "light"], softIntro: "A sound and light machine that helps create a calming sleep routine is" },
  ...
  // === AROMATHERAPY (15) ===
  { name: "doTERRA Lavender Essential Oil", asin: "B007P70UKQ", category: "aromatherapy", tags: ["lavender", "calm", "sleep", "anxiety", "aromatherapy", "essential-oil"], softIntro: "A calming essential oil that many find soothing is" },
  ...
  { name: "Plant Therapy Frankincense Oil", asin: "B007P70UKQ", category: "aromatherapy", tags: ["frankincense", "grounding", "calm", "meditation", "aromatherapy"], softIntro: "For grounding aromatherapy, an oil that many find centering is" },
  ...
  { name: "Singing Bowl Set", asin: "B06XHN7VRG", category: "audio", tags: ["singing-bowl", "meditation", "sound", "vibration", "grounding", "calm"], softIntro: "A singing bowl that some find grounding through vibration is" },
  ...
  // === FIDGET & GROUNDING (20) ===
  { name: "Speks Magnetic Balls", asin: "B074WDJNH3", category: "fidget", tags: ["fidget", "magnetic", "grounding", "hands", "anxiety", "focus"], softIntro: "A fidget tool that keeps hands busy during anxious moments is" },
  ...
  { name: "Worry Stone - Amethyst", asin: "B0BBWBX4N3", category: "fidget", tags: ["grounding", "stone", "tactile", "anxiety", "touch", "calm"], softIntro: "A simple grounding stone that fits in your pocket is" },
  { name: "Breathing Necklace - Shift", asin: "B09XS7JWHH", category: "fidget", tags: ["breathing", "grounding", "anxiety", "slow", "exhale", "tool"], softIntro: "A breathing tool that helps slow the exhale for nervous system regulation is" },
  ...
  { name: "Thinking Putty - Crazy Aaron's", asin: "B074WDJNH3", category: "fidget", tags: ["putty", "fidget", "sensory", "tactile", "grounding", "hands"], softIntro: "A sensory putty that helps with grounding through touch is" },
  { name: "Stress Ball Set", asin: "B01AVDVHTI", category: "fidget", tags: ["stress", "squeeze", "hands", "tension", "release", "fidget"], softIntro: "Simple stress balls that help release tension through the hands are" },
